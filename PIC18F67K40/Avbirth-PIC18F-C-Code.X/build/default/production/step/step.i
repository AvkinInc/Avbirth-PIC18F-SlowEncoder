...
# 62 "mcc_generated_files/interrupt_manager.h"
typedef enum {
    NULL_ACTION,
    STEPPER_STOP,
...
# 149 "mcc_generated_files/interrupt_manager.h"
void __attribute__((picinterrupt(("")))) INTERRUPT_InterruptManager(void);
# 161 "mcc_generated_files/interrupt_manager.h"
...
# 328 "mcc_generated_files/tmr4.h"
void TMR4_Initialize(void);
# 364 "mcc_generated_files/tmr4.h"
void TMR4_ModeSet(TMR4_HLT_MODE mode);
# 399 "mcc_generated_files/tmr4.h"
void TMR4_ExtResetSourceSet(TMR4_HLT_EXT_RESET_SOURCE reset);
# 428 "mcc_generated_files/tmr4.h"
void TMR4_Start(void);
# 457 "mcc_generated_files/tmr4.h"
void TMR4_StartTimer(void);
# 489 "mcc_generated_files/tmr4.h"
void TMR4_Stop(void);
# 521 "mcc_generated_files/tmr4.h"
void TMR4_StopTimer(void);
# 556 "mcc_generated_files/tmr4.h"
uint8_t TMR4_Counter8BitGet(void);
# 591 "mcc_generated_files/tmr4.h"
uint8_t TMR4_ReadTimer(void);
# 630 "mcc_generated_files/tmr4.h"
void TMR4_Counter8BitSet(uint8_t timerVal);
# 669 "mcc_generated_files/tmr4.h"
void TMR4_WriteTimer(uint8_t timerVal);
# 721 "mcc_generated_files/tmr4.h"
void TMR4_Period8BitSet(uint8_t periodVal);
# 773 "mcc_generated_files/tmr4.h"
void TMR4_LoadPeriodRegister(uint8_t periodVal);
# 791 "mcc_generated_files/tmr4.h"
void TMR4_ISR(void);
# 809 "mcc_generated_files/tmr4.h"
 void TMR4_CallBack(void);
# 826 "mcc_generated_files/tmr4.h"
 void TMR4_SetInterruptHandler(void (* InterruptHandler)(void));
# 844 "mcc_generated_files/tmr4.h"
extern void (*TMR4_InterruptHandler)(void);
# 862 "mcc_generated_files/tmr4.h"
...
# 636 "mcc_generated_files/adcc.h"
uint16_t ADCC_GetErrorCalculation(void);
# 658 "mcc_generated_files/adcc.h"
void ADCC_EnableDoubleSampling(void);
# 680 "mcc_generated_files/adcc.h"
...
# 785 "mcc_generated_files/adcc.h"
...
# 1 "mcc_generated_files/eusart4.h" 1
# 97 "mcc_generated_files/eusart4.h"
void EUSART4_Initialize(void);
# 145 "mcc_generated_files/eusart4.h"
_Bool EUSART4_is_tx_ready(void);
# 193 "mcc_generated_files/eusart4.h"
_Bool EUSART4_is_rx_ready(void);
# 240 "mcc_generated_files/eusart4.h"
_Bool EUSART4_is_tx_done(void);
# 260 "mcc_generated_files/eusart4.h"
uint8_t EUSART4_Read(void);
# 280 "mcc_generated_files/eusart4.h"
void EUSART4_Write(uint8_t txData);
# 60 "step/../mcc_generated_files/mcc.h" 2

# 1 "mcc_generated_files/eusart2.h" 1
# 97 "mcc_generated_files/eusart2.h"
void EUSART2_Initialize(void);
# 145 "mcc_generated_files/eusart2.h"
_Bool EUSART2_is_tx_ready(void);
# 193 "mcc_generated_files/eusart2.h"
_Bool EUSART2_is_rx_ready(void);
# 240 "mcc_generated_files/eusart2.h"
_Bool EUSART2_is_tx_done(void);
# 260 "mcc_generated_files/eusart2.h"
uint8_t EUSART2_Read(void);
# 280 "mcc_generated_files/eusart2.h"
void EUSART2_Write(uint8_t txData);
# 61 "step/../mcc_generated_files/mcc.h" 2
# 77 "step/../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 90 "step/../mcc_generated_files/mcc.h"
void OSCILLATOR_Initialize(void);
# 103 "step/../mcc_generated_files/mcc.h"
...
void inchForwards(step_size size) {
    ...
    Step(FORWARDS, (200 * 2 * multiplier), size);
}
...
void inchBackwards(step_size size) {
    ...
    Step(BACKWARDS, (200 * 2 * multiplier), size);
}
...
void setStepSize(step_size size) {
    switch (size) {
        case Full:
        {
            ...
            do { LATHbits.LATH0 = 0; } while(0);
            do { LATAbits.LATA5 = 0; } while(0);
            break;
        }
        case Half:
        {
            do { LATHbits.LATH1 = 1; } while(0);
            do { LATHbits.LATH0 = 0; } while(0);
            do { LATAbits.LATA5 = 0; } while(0);
            break;
        }
