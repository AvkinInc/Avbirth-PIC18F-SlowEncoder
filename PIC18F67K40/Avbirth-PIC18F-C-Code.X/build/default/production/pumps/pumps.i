...
# 53 "pumps/../mcc_generated_files/mcc.h" 2
...
# 77 "pumps/../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 90 "pumps/../mcc_generated_files/mcc.h"
void OSCILLATOR_Initialize(void);
# 103 "pumps/../mcc_generated_files/mcc.h"
...
void setPump1PWM(uint16_t pwm){
    ...
    Pumps.Pump1_PWM = pwm;
    if(Pumps.Pump1_PWM == 0){
        do { LATFbits.LATF2 = 0; } while(0);
        if(Pumps.Pump2_PWM == 0){
