# 1 "EUSART_Helpers/EUSART_Helpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "EUSART_Helpers/EUSART_Helpers.c" 2
# 1 "EUSART_Helpers/./EUSART_Helpers.h" 1
...
# 6 "EUSART_Helpers/./EUSART_Helpers.h" 2
...
# 2 "EUSART_Helpers/EUSART_Helpers.c" 2
# 1 "EUSART_Helpers/../mcc_generated_files/mcc.h" 1
# 49 "EUSART_Helpers/../mcc_generated_files/mcc.h"
...
# 50 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2
# 1 "mcc_generated_files/device_config.h" 1
# 51 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2
# 1 "mcc_generated_files/pin_manager.h" 1
# 362 "mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 374 "mcc_generated_files/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 52 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c99\\stdbool.h" 1 3
# 54 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2
...
# 58 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2
...
# 61 "EUSART_Helpers/../mcc_generated_files/mcc.h" 2
# 75 "EUSART_Helpers/../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 88 "EUSART_Helpers/../mcc_generated_files/mcc.h"
void OSCILLATOR_Initialize(void);
# 101 "EUSART_Helpers/../mcc_generated_files/mcc.h"
void PMD_Initialize(void);
# 3 "EUSART_Helpers/EUSART_Helpers.c" 2
...
void write1byteHex(uint8_t in){
    ...
    uart_write('x');
    if(((in>>4) & 0xF) > 9){
        uart_write(((in>>4) & 0xF) + 0x37);
    }else{
        uart_write(((in>>4) & 0xF) + 0x30);
    }
    if((in & 0x0F) > 9){
        uart_write((in & 0x0F) + 0x37);
    }else{
        uart_write((in & 0x0F) + 0x30);
    }
}
...
void write2bytesHex(uint16_t in){
    ...
    uart_write('x');
    if(((in>>12) & 0xF) > 9){
        uart_write((in>>12) + 0x37);
    }else{
        uart_write((in>>12) + 0x30);
    }
    if(((in>>8) & 0x0F) > 9){
        uart_write(((in>>8) & 0x0F) + 0x37);
    }else{
        uart_write(((in>>8) & 0x0F) + 0x30);
    }
    if(((in>>4) & 0x00F) > 9){
        uart_write(((in>>4) & 0x00F) + 0x37);
    }else{
        uart_write(((in>>4) & 0x00F) + 0x30);
    }
    if((in & 0x000F) > 9){
        uart_write((in & 0x000F) + 0x37);
    }else{
        uart_write((in & 0x000F) + 0x30);
    }
}
...
void write4bytesHex(unsigned long in){
    ...
    uart_write('x');
    if(((in>>28) & 0xF) > 9){
        uart_write((in>>28) + 0x37);
    }else{
        uart_write((in>>28) + 0x30);
    }
    if(((in>>24) & 0x0F) > 9){
        uart_write(((in>>24) & 0x0F) + 0x37);
    }else{
        uart_write(((in>>24) & 0x0F) + 0x30);
    }
    if(((in>>20) & 0x00F) > 9){
        uart_write(((in>>20) & 0x00F) + 0x37);
    }else{
        uart_write(((in>>20) & 0x00F) + 0x30);
    }
    if(((in>>16) & 0x000F) > 9){
        uart_write(((in>>16) & 0x000F) + 0x37);
    }else{
        uart_write(((in>>16) & 0x000F) + 0x30);
    }
    if(((in>>12) & 0x0000F) > 9){
        uart_write(((in>>12) & 0x0000F) + 0x37);
    }else{
        uart_write(((in>>12) & 0x0000F) + 0x30);
    }
    if(((in>>8) & 0x00000F) > 9){
        uart_write(((in>>8) & 0x00000F) + 0x37);
    }else{
        uart_write(((in>>8) & 0x00000F) + 0x30);
    }
    if(((in>>4) & 0x000000F) > 9){
        uart_write(((in>>4) & 0x000000F) + 0x37);
    }else{
        uart_write(((in>>4) & 0x000000F) + 0x30);
    }
    if((in & 0x0000000F) > 9){
        uart_write((in & 0x0000000F) + 0x37);
    }else{
        uart_write((in & 0x0000000F) + 0x30);
    }
}
